...
<G4Studio:html title="考勤维护：oa数据管理" uxEnabled="true">
<G4Studio:import src="/hr/adc/js/manageOaIntf.js" />
<G4Studio:ext.codeRender fields="CLBZ"/>
<G4Studio:ext.codeStore fields="CLBZ"/>
<G4Studio:body>
