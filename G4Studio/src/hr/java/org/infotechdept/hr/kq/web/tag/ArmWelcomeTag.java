...
/**
 * ArmWelcomeTag标签:G4Studio_ARM专用
 * 
 * @author xuyan
 * @since 2015-02-10
 */
public class ArmWelcomeTag extends TagSupport {
	private static Log log = LogFactory.getLog(ArmWelcomeTag.class);
	...
	public int doStartTag() throws JspException {
		...
		fileList = g4Dao.queryForList("Demo.queryFiles", new BaseDto());
		Dto dto = new BaseDto();
		dto.put("fileList", fileList);
