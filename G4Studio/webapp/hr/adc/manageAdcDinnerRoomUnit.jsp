...
<G4Studio:html title="食堂就餐单位管理">
<G4Studio:import src="/hr/adc/js/manageAdcDinnerRoomUnit.js"/>
<G4Studio:ext.codeRender fields="UNIT_TYPE"/>
<G4Studio:ext.codeStore fields="UNIT_TYPE"/>
<G4Studio:body>
